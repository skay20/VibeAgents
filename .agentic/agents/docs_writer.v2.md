...
4. For generated projects, write/update README at `settings.docs.project_readme_path`.
...
5. Update docs with exact commands/paths, including `docs/QUICKSTART.md` when applicable.
6. Emit docs report artifact.
